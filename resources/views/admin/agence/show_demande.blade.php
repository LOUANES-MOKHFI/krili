...
@section('content')
 <div class="content-header" style="margin-top: 0px;padding: 0px 0px ">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">AFFICHE UNE DEMANDE D'AGENCE</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="car-details-content">
                        <h1 class="uppercase">{{$agence->name}}</h1>
                        <div class="car-preview-crousel">
                            <div class="single-car-preview">
                                <img src="{{asset('/images/'.$agence->logo)}}" alt="JSOFT" width="500" height="300">
                            </div>
                        </div>
    ...
    <div class="tab-content bg-transparent">
        <div id="note-full-container" class="note-has-grid">
            <div class=" single-note-item all-category" style="">
                <div class="card card-body">
                    <span class="side-stick"></span>
                    <h5 class="note-title text-truncate w-75 mb-0" >Information de l'agence </h5>
                     <div class="sidebar-body">
                        <p><i class="fa fa-mobile"></i>  +213{{$agence->num_tlfn}}</p>
                        <p><i class="fa fa-map-marker"></i>  {{$agence->wilaya}} - {{$agence->ville}}</p>
                      ...
                      <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <div class="social-icons text-center">
                                  ...
                                  <p> Aucun page de reseau social</p>
                                  @else
                                  @if(!empty($agence->fb))
                                    <a href="{{url($agence->fb)}}" target="_blank"><i class="fa fa-facebook"></i></a>
                                    @endif
                                    @if(!empty($agence->twitter))
                                    <a href="{{url($agence->twitter)}}" target="_blank"><i class="fa fa-twitter"></i></a>
                                     @endif
                                    @if(!empty($agence->insta))
                                    <a href="{{url($agence->insta)}}" target="_blank"><i class="fa fa-linkedin"></i></a>
                                     @endif
                                     @endif
                                </div>
                            </div>
