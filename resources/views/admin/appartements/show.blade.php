        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/admin/appartements')}}">Liste des vehicule</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="car-details-content">
                        <h1 class="uppercase">{{$appartement->type_appartement}} à {{$appartement->ville}}</h1>
                        <div class="car-preview-crousel">
                            <div class="single-car-preview">
                                <img src="{{asset('/images/'.$appartement->image1)}}" alt="{{$appartement->type_appartement}}" width="350" height="300">
                                <img src="{{asset('/images/'.$appartement->image2)}}" alt="{{$appartement->type_appartement}}" width="350" height="300">
                                <img src="{{asset('/images/'.$appartement->image3)}}" alt="{{$appartement->type_appartement}}" width="350" height="300">
                            </div>
                        </div>
